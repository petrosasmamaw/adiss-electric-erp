...
import { setCredentials, setLoading } from "@/lib/features/authSlice";
...
export default function AuthCheck({ children }) {
  ...
  useEffect(() => {
    ...
    } else if (!isPublicRoute && !isAuthenticated && !isLoading) {
  ...
  }, [data, isLoading, error, dispatch, isAuthenticated, router, pathname, isPublicRoute]);
