        ...
        <div className="relative w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl p-8 space-y-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-300 text-sm">This password reset link is invalid or has expired.</p>
              <Link
                href="/forgot-password"
                className="inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200"
              >
                Request New Link
              </Link>
            </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-300 text-sm">Set a strong password for your account</p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-green-500/10 border border-green-500/50 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-green-200 text-sm font-medium">Password reset successfully!</p>
                </div>
              </div>
              <p className="text-center text-slate-400 text-sm">Redirecting to login...</p>
            </div>
          ) : (
            <>
              {error && (
